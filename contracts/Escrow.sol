...
contract Escrow {
    ...
    function applyAsAuditor(uint256 escrowId) external {
    ...
    function assignAuditor(uint256 escrowId, uint256 applicationId) external onlyCompany(escrowId) {
    ...
    function markCompleted(uint256 escrowId) external onlyAuditor(escrowId) {
        EscrowDeal storage escrow = escrows[escrowId];
    ...
    function verifyCompletion(uint256 escrowId, bool _verified) external onlyCompany(escrowId) {
        EscrowDeal storage escrow = escrows[escrowId];
    ...
    function transferDeposit(uint256 escrowId) internal {
        EscrowDeal storage escrow = escrows[escrowId];
    ...
    function refundDeposit(uint256 escrowId) internal {
        EscrowDeal storage escrow = escrows[escrowId];
